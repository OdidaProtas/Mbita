    ...
    return (
      <>
        ...
        <LottieView
          ...
          source={require("../../../../assets/24151-ecommerce-animation.json")}
        ...
        image: (
          <>
            <LottieView
              ...
              source={require("../../../../assets/3616-shopping-bag.json")}
              // progress={this.state.progress}
            />
          </>
        ),
      },
      {
        ...
        image: (
          <LottieView
            ...
            source={require("../../../../assets/54350-online-shopping-delivery.json")}
            // progress={this.state.progress}
          />
        ),
      },
